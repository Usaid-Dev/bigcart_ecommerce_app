              ...
              children: [
                ...
                const Align(
                  ...
                  child: Text(
                      ...
                      style:
                      TextStyle(fontWeight: FontWeight.w500, fontSize: 15, color: Color(0xff868889)
                      )
                  ),
                ),
                const Spacer(),
                ...
                const Align(
                  alignment: Alignment.center,
                  child: Text("POWERED BY", style: TextStyle(fontWeight: FontWeight.w500,
                      fontSize: 16, letterSpacing: 7, color: Color(0xff868889)
                  )
                  ),
                ),
                ...
                Align(
                  alignment: Alignment.center,
                  child: Text("TECH IDARA", style: TextStyle(fontWeight: FontWeight.w600,
                      fontSize: 20, letterSpacing: 8, wordSpacing: 8,
                      color: Theme.of(context).primaryColorDark)
                  ),
                ),
