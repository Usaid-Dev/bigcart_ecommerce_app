              ...
              Padding(padding: const EdgeInsets.all(1.0),
                  ...
                  return
                    Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      provider.isProductFavorite(widget.productId) ?
                      Material(color: Colors.transparent,
                        child: InkWell(borderRadius: BorderRadius.circular(20),
                            ...
                            child: const Padding(padding: EdgeInsets.all(5.0),
                                child: Icon(Icons.favorite,color: Color(0xFFFE585A))))):
                         Material(
                      ...
                      return Row(
                          ...
                          children: [
                              ...
                              Material(
                                ...
                                child: InkWell(borderRadius: BorderRadius.circular(20),
                                  ...
                                  cartProvider.addProductToCart(CartModel(
                                      ...
                                      color: widget.color));
                                  for (var element in cartProvider.cartProductList) {
                                    print(
                            ...
                            if (provider.isProductAdded(widget.productId) == true) ...[
                              ...
                              Text('${provider.getProductQyt(widget.productId)}',
